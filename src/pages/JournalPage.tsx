...
import { Plus, Trash2, Calendar, Brain, Heart, ChevronLeft, ChevronRight, CheckCircle2, Download, CalendarSearch } from "lucide-react";
...
function createEmptyEntry(date: string): DailyEntry {
  return { id: crypto.randomUUID(), date, tasks: [], mentalStatus: { morning: 2, afternoon: 2, night: 2 }, physicalStatus: "good", physicalNote: "", mentalNote: "", journal: "" };
}
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <Button variant="ghost" size="icon" onClick={() => dateInputRef.current?.showPicker()} title="Pick a date">
              <CalendarSearch className="w-4 h-4" />
            </Button>
            <input ref={dateInputRef} type="date" value={dateKey} onChange={handleDatePick} className="absolute inset-0 opacity-0 w-full h-full cursor-pointer" tabIndex={-1} />
          </div>
